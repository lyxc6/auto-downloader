...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'src.controllers.scan_runner',
        'src.controllers.size_prefetcher',
        'src.presenters',
        'src.presenters.scan_presenter',
        'src.presenters.download_presenter',
        'src.presenters.auto_save',
        'src.views',
